...
#TODO: блок оценки фотографии вправо от кнопки "Пропустить" 

#TODO: попробовать использовать единый метод для загрузки фото на сервера вконтакте (для стены и альбома)
